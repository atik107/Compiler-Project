...
%token VOIDMAIN NUM VAR PST PEN STRING_LITERAL BST BEN SM INT FLOAT CHAR ARRAY GCD LCM INC DEC AND OR IF ELSE ELSEIF FOR WHILE CASE SWITCH DEFAULT PRINTFUNCTION PLUS MINUS MUL DIV MOD LT GT LE GE FACTORIAL ODDEVEN PRIME SORT SQR SQRT EXP POW LOG SIN COS TAN TRY CATCH  FUNCTION FUN MAX MIN FNRETURN
%nonassoc ELSE
%nonassoc IFX
%nonassoc FOR
%nonassoc FUNCTION
